...
const PropertyEditForm = ({ property }) => {
  // When this component is rendered , next ja creates a reference to handleEditForm function and passes that reference to the form action attribute.
  // This allows the form to call handleEditForm from the browser.
  const handleEditForm = async (formData) => {
    ...
    // You can handle any additional logic here, like showing a success message
